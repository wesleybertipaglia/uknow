...
import { Home, Users, Milestone, LogOut, User as UserIcon, PlusCircle } from "lucide-react";
...
export default function Header() {
  const { currentUser, logout, addCommunity } = useAppContext();
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuItem onClick={() => setCreateCommunityModalOpen(true)}>
